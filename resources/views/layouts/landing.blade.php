        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}">
                <div class="inline-flex items-center bg-white/80 backdrop-blur-sm border border-primary/20 rounded-full px-4 py-2 mb-6 shadow-sm">
                    ...
                    <span class="text-sm font-semibold text-primary">{{ __('messages.money_back_guarantee') }}</span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-{{ app()->getLocale() == 'ar' ? 'end' : 'start' }}">
                    <a href="{{ url('/tutors') }}" class="bg-primary hover:bg-green-800 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-1 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                        {{ __('messages.find_tutor') }}
                    </a>
                    <a href="{{ route('register') }}" class="bg-white hover:bg-surface text-primary border-2 border-primary px-8 py-4 rounded-xl font-bold text-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-1 flex items-center justify-center gap-2">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @foreach($features as $feature)
                <div class="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition card-hover border border-primary/5">
                    <div class="w-12 h-12 bg-{{ $feature['color'] }}/10 rounded-xl flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-{{ $feature['color'] }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $feature['icon'] }}"/></svg>
                    </div>
...
<section class="py-16 bg-primary text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
                <div class="text-4xl lg:text-5xl font-extrabold text-amber-300 mb-2">500+</div>
                <div class="text-green-100 font-medium">{{ __('messages.tutors_count') }}</div>
            </div>
            <div>
                <div class="text-4xl lg:text-5xl font-extrabold text-amber-300 mb-2">2,000+</div>
                <div class="text-green-100 font-medium">{{ __('messages.students_count') }}</div>
            </div>
            <div>
                <div class="text-4xl lg:text-5xl font-extrabold text-amber-300 mb-2">10,000+</div>
                <div class="text-green-100 font-medium">{{ __('messages.lessons_count') }}</div>
            </div>
            <div>
                <div class="text-4xl lg:text-5xl font-extrabold text-amber-300 mb-2">98%</div>
                ...
                <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition overflow-hidden border border-primary/5 card-hover">
                    ...
                    <div class="pt-12 pb-6 px-6 text-center">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            <span class="text-secondary font-bold text-lg">{{ $tutor['price'] }} <span class="text-sm text-gray-500 font-normal">/ {{ __('messages.hour') }}</span></span>
...
<section class="py-20 bg-primary relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('register') }}" class="bg-secondary hover:bg-amber-600 text-white px-10 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
                {{ __('messages.join_now') }}
            </a>
            <a href="{{ url('/tutors') }}" class="bg-white/10 hover:bg-white/20 text-white border-2 border-white/30 px-10 py-4 rounded-xl font-bold text-lg transition">
                {{ __('messages.find_tutor') }}
            </a>
        </div>
    </div>
