...
<head>
    ...
    <title>403 - Forbidden - OstazON</title>
...
<body class="bg-bg-lime min-h-screen flex items-center justify-center p-4">
    <div class="text-center max-w-md">
        <div class="text-8xl font-extrabold text-primary/20 mb-4">403</div>
        <h1 class="text-3xl font-extrabold text-text-dark mb-3">Access Denied</h1>
